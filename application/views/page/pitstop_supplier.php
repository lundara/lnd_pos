					...
					<div class="col-md-12">
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-database"></i> Data Vendor
								</div>
								<div class="tools">
								...
								<div class="">
									...
									<table class="table table-striped table-bordered table-hover" id="datatable_ajax">
										...
										<thead>
											<tr>
												<th></th>
												<th><input class="form-control" id="src_nama" placeholder="Cari Vendor..."></th>
												<th></th>
												<th></th>
												<th></th>
												<th></th>
...
<script>
	...
	$(document).ready(function() {
		...
		$("#add-form").on("submit",(function(e){
			...
			if (nama && alamat !=="") {
				$.ajax({
					url:"<?php echo base_url()?>pitstop/supplier/tambah",
					type:"POST",
		...
		$("#edit-form").on("submit",(function(e){
			...
			if (nama && alamat !=="") {
				$.ajax({
					url:"<?php echo base_url()?>pitstop/supplier/update",
					type:"POST",
	    ...
	    table = $('#datatable_ajax').DataTable({ 
	        ...
	        "ajax": {
	            "url": "<?php echo site_url('pitstop/supplier/data')?>",
	            "type": "POST",
	            "data":function ( d ) {
	                  return $.extend( {}, d, {
	...
	function cetak(){
		...
		window.open('<?php echo base_url() ?>pitstop/supplier/cetak', '_blank');
	...
	function edit(id){
		getId(id);
		$.ajax({
			url:"<?php echo base_url()?>pitstop/supplier/edit",
			type:"POST",
			data: {id},
			daraType:"json",
			cache:false,
	...
	function del(){
		var id = $("#get_id").val();
		$.ajax({
			url:"<?php echo base_url()?>pitstop/supplier/hapus",
			type:"POST",
			data: {id},
			daraType:"json",
			cache:false,
