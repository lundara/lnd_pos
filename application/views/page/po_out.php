...
<script>
	...
	$(document).ready(function() {
	    ...
	    table = $('#datatable_ajax').DataTable({ 
	        ...
	        "ajax": {
	            "url": "<?php echo site_url('po_out/data')?>",
	            "type": "POST",
	            "dataType":"json",
	            "data":function ( d ) {
	                  return $.extend( {}, d, {
	...
	function unduh(){
		...
		window.open('<?php echo base_url() ?>po_out/excel?src_po='+src_po+'&src_from='+src_from+'&src_to='+src_to+'&src_supplier='+src_supplier+'&src_user='+src_user+'&src_status='+src_status+'&src_bayar='+src_bayar, '_blank');
	...
	function detail(id){
		...
		$.ajax({
			type:"POST",
			url:"<?php echo base_url() ?>po_out/detail",
			dataType:"json",
			data:{id},
			beforeSend:function(){
	...
	function rev(){
		...
		if (id && qty && harga && disc && ket_rev !=="") {
			$.ajax({
				...
				type:"POST",
				url:"<?php echo base_url();?>po_out/rev_item",
				dataType:"json",
	...
	function save_rev(){
		...
		if (kode && no_trans !=="") {
			$.ajax({
				...
				type:"POST",
				url:"<?php echo base_url();?>po_out/save_rev",
				dataType:"json",
				data:{no_trans, kode},
				beforeSend:function(){
	...
	function save(){
		...
		if (supplier && quot !== "") {
			...
			$.ajax({
				...
				type:"POST",
				url:"<?php echo base_url() ?>po_out/save",
				dataType:"json",
				data:{no_trans, item, supplier, quot, cek_ppn},
				beforeSend:function(){
	...
	function dt(){
		$.ajax({
			...
			type:"POST",
			url:"<?php echo base_url();?>po_out/data_item",
			dataType:"json",
			beforeSend:function(){
	...
	function del(id, i){
		...
		$.ajax({
			...
			type:"POST",
			url:"<?php echo base_url();?>po_out/del",
			dataType:"json",
			data:{id},
			beforeSend:function(){
	...
	function add(){
		...
		if (id && qty !=="") {
			$.ajax({
				...
				type:"POST",
				url:"<?php echo base_url();?>po_out/add",
				dataType:"json",
	...
	function get_trans(){
		$.ajax({
			type:"POST",
			url:"<?php echo base_url() ?>po_out/get_trans",
			dataType:"json",
			success:function(data){
