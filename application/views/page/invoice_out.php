<div class="page-content">
				...
				<!-- BEGIN PAGE HEADER-->
				<h3 class="page-title">
					Invoice Out<small></small>
				</h3>
				<div class="page-bar">
					<ul class="page-breadcrumb">
						<li>
							<i class="fa fa-cubes"></i>
							<a href="javascript:;">Invoice Out</a>
						</li>
					</ul>
					...
					<div class="col-md-12">
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-database"></i> Data Invoice Out
								</div>
								<div class="tools">
	...
	<div class="modal-dialog modal-dialog-big">
		<div class="modal-content modal-content-big">
			<div class="modal-header">
				...
				<h4 class="modal-title">Tambah Invoice Out</h4>
			</div>
					...
					<div class="row">
						<div class="col-md-8">
							<div class="form-group">
								<label style="font-weight: bold">No. Invoice Out : <span id="no_inv"></span></label>
							</div>
						 	...
						 	<div class="row">
							 	<div class="col-md-6 col-sm-12">
							 		<div class="form-group">
								 		<label>Ket. Term </label>
								 		<input class="form-control" id="ket_term" >
								 	</div>
								 	<div class="form-group">
								 		<label>Term <span class="require"></span></label>
							 	...
							 	<div class="col-md-6 col-sm-12">
							 		<div class="form-group">
								 		<label>Ket. Tax </label>
								 		<input class="form-control" id="ket_tax">
								 	</div>
								 	<div class="form-group">
								 		<label>Tax <span class="require"></span></label>
								 		<input class="form-control rupiah" id="tax" style="text-align: right;">
								 	</div>
							 	</div>
						 	</div>
...
<script>
	...
	function save(){
		...
		var tax = $("#tax").val();
		var ket_term = $("#ket_term").val();
		var ket_tax  = $("#ket_tax").val();
		//alert(no_trans+" "+bayar+" "+tempo+" "+po+" "+sisa+" "+type+no_do);
		if (no_trans && bayar && tempo && po && type && tax !== "") {

			$.ajax({

				type:"POST",
				url:"<?php echo base_url() ?>invoice_out/save",
				dataType:"json",
				data:{no_trans, bayar, tempo, po, sisa, type, no_do, tax, ket_tax, ket_term},
				beforeSend:function(){
