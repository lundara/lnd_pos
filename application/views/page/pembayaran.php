					 ...
					 <div class="row">
					 	<div class="col-md-12 col-sm-12">
						 	<div class="form-group">
								<label>Metode Pembayaran <span class="require"></span> </label>
						 ...
						 <div class="col-md-12 col-sm-12">
						 	<div class="form-group">
								...
								<textarea class="form-control inp" id="eket" style="resize: none;height: 200px;"></textarea>
							</div>
						 </div>
 						 <div class="col-md-12">
						 	<div class="form-group">
				...
				<div class="modal-body">
						 <div class="row">
							 ...
							 <div class="col-md-12 col-sm-12">
							 	<div class="form-group">
									<label>Keterangan</label>
									<textarea class="form-control" id="ket" style="resize: none;height: 200px;"></textarea>
								</div>
							 </div>
	 						 <div class="col-md-12">
							 	<div class="form-group">
...
<script>
	...
	$(document).ready(function() {
		...
		$("#add-form").on("submit",(function(e){
			...
			if (nama !=="") {
				$.ajax({
					url:"<?php echo base_url()?>pembayaran/tambah",
					type:"POST",
					data: {nama, ket},
					daraType:"json",
					cache:false,
		...
		$("#edit-form").on("submit",(function(e){
			...
			if (nama !=="") {
				$.ajax({
					url:"<?php echo base_url()?>pembayaran/update",
					type:"POST",
					data: {nama, ket, id},
					daraType:"json",
					cache:false,
	...
	function edit(id){
		...
		$.ajax({
			...
			success:function(data){
				$("#enama").val(data[0].nama_pembayaran);
				$("#eket").val(data[0].ket);
			},
			complete:function(){
