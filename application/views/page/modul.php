					...
					<div class="col-md-12">
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-database"></i> Data Modul
								</div>
								<div class="tools">
									...
									<table class="table table-striped table-bordered table-hover" id="datatable_ajax">
										...
										<thead>
											<tr>
												<th></th>
												<th></th>
												<th><input class="form-control" id="src_nama" placeholder="Cari Modul..."></th>
												<th></th>
												<th></th>
											</tr>
										</thead>
...
<script>
	...
	$(document).ready(function() {
		...
		$("#add-form").on("submit",(function(e){
			...
			if (nama!=="") {
				$.ajax({
					url:"<?php echo base_url()?>modul/tambah",
					type:"POST",
					data: {nama, icon, aktif},
					dataType:"json",
					cache:false,
					beforeSend:function(){
		...
		$("#edit-form").on("submit",(function(e){
			...
			if (nama!=="") {
				$.ajax({
					url:"<?php echo base_url()?>modul/update",
					type:"POST",
					data: {nama, id, icon, aktif},
					daraType:"json",
					cache:false,
					beforeSend:function(){
	    ...
	    table = $('#datatable_ajax').DataTable({ 
	        ...
	        "ajax": {
	            "url": "<?php echo site_url('modul/data')?>",
	            "type": "POST",
	            "data":function ( d ) {
	                  return $.extend( {}, d, {
	...
	function edit(id){
		getId(id);
		$.ajax({
			url:"<?php echo base_url()?>modul/edit",
			type:"POST",
			data: {id},
			daraType:"json",
			cache:false,
