					...
					<div class="col-md-12">
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-database"></i> Data Pembelian
								</div>
								<div class="tools">
						 	...
						 	<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									...
									<tfoot>
										...
										<tr>
											<th colspan="5"><center>PPN 10%</center></th>
...
<script>
	...
	$(document).ready(function() {
	    ...
	    table = $('#datatable_ajax').DataTable({ 
	        ...
	        "ajax": {
	            "url": "<?php echo site_url('pembelian/data')?>",
	            "type": "POST",
	            "dataType":"json",
	            "data":function ( d ) {
	                  return $.extend( {}, d, {
	...
	function unduh(){
		...
		window.open('<?php echo base_url() ?>pembelian/excel?src_po='+src_po+'&src_from='+src_from+'&src_to='+src_to+'&src_supplier='+src_supplier+'&src_user='+src_user+'&src_status='+src_status, '_blank');
	...
	function detail(id){
		...
		$.ajax({
			type:"POST",
			url:"<?php echo base_url() ?>pembelian/detail",
			dataType:"json",
			data:{id},
			beforeSend:function(){
	...
	function dt(){
		$.ajax({
			...
			type:"POST",
			url:"<?php echo base_url();?>pembelian/data_item",
			dataType:"json",
			beforeSend:function(){
	...
	function del(id, i){
		...
		$.ajax({
			...
			type:"POST",
			url:"<?php echo base_url();?>pembelian/del",
			dataType:"json",
			data:{id},
			beforeSend:function(){
	...
	function get_trans(){
		$.ajax({
			type:"POST",
			url:"<?php echo base_url() ?>pembelian/get_trans",
			dataType:"json",
			success:function(data){
