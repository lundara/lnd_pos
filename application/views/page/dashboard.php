...
<div class="page-content">
				...
				<div class="tabbable-custom " style="margin-bottom:0 !important;">
					<ul class="nav nav-tabs ">
						...
						<li>
							<a href="<?php echo base_url() ?>dashboard/pitstop">
								THE PIT STOP
							</a>
						</li>
					</ul>
						...
						<div class="tab-pane active" id="tab_cbtekno">
							<div class="row">
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
									<a class="dashboard-stat dashboard-stat-light yellow" href="<?php echo base_url() ?>inquiry">
									<div class="visual">
										<i class="fa fa-cart-plus"></i>
									</div>
									<div class="details">
										<div class="number" id="inq_hari">
											 0
										</div>
										<div class="desc">
											Inquiry Hari Ini
								...
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
									<a class="dashboard-stat dashboard-stat-light green-soft" href="<?php echo base_url() ?>quotation">
									<div class="visual">
										<i class="fa fa-cart-plus"></i>
									</div>
									<div class="details">
										<div class="number" id="quot_hari">
											 0
										</div>
										<div class="desc">
											Quotation Hari Ini
							...
							<div class="row">
								...
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
									<a class="dashboard-stat dashboard-stat-light red-soft" href="<?php echo base_url() ?>po_in">
									<div class="visual">
										<i class="fa fa-cart-plus"></i>
									</div>
									<div class="details">
										<div class="number" id="po_in_hari">
											 0
										</div>
										<div class="desc">
											Purchase Order In Hari Ini 
										</div>
									</div>
									</a>
								</div>
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
									...
									<div class="details">
										<div class="number" id="po_in_bln">
											 0
										</div>
										<div class="desc">
											Purchase Order In Bulan Ini 
										</div>
									</div>
									</a>
								</div>
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
									<a class="dashboard-stat dashboard-stat-light blue-soft" href="<?php echo base_url() ?>po_out">
									<div class="visual">
										<i class="fa fa-cart-plus"></i>
									</div>
									<div class="details">
										<div class="number" id="po_out_hari">
											 0
										</div>
										<div class="desc">
											Purchase Order Out Hari Ini
										</div>
									</div>
									</a>
								</div>
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
									...
									<div class="details">
										<div class="number" id="po_out_bln">
											 0
										</div>
										<div class="desc">
											Purchase Order Out Bulan Ini
										</div>
									</div>
									</a>
								</div>
							...
							<div class="row">
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
									<a class="dashboard-stat dashboard-stat-light purple-soft" href="<?php echo base_url() ?>invoice_out">
									<div class="visual">
										<i class="fa fa-cart-plus"></i>
									</div>
									<div class="details">
										<div class="number" id="inv_out_hari">
											 0
										</div>
										<div class="desc">
											Invoice Out Hari Ini 
										</div>
									</div>
									</a>
								</div>
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
									...
									<div class="details">
										<div class="number" id="inv_out_bln">
											 0
										</div>
										<div class="desc"> 
											Invoice Out Bulan Ini 
										</div>
									</div>
									</a>
								</div>
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
									...
									<div class="details">
										<div class="number" id="krm_hari">
											 10
										</div>
										<div class="desc">
											Invoice Out Hari Ini <br>(Belum Aktif)
										</div>
									</div>
									</a>
								</div>
								<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
									...
									<div class="details">
										<div class="number" id="krm_bln">
											 380
										</div>
										<div class="desc">
											Invoice Out Bulan Ini <br>(Belum Aktif)
										</div>
									</div>
									</a>
								</div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		//chart_penjualan("#chart_penjualan_loading", "#chart_penjualan_content", "#chart_penjualan_error",  "#chart_penjualan", "#3A9C96");
		card();
		act();
		//pie2();
	...
	function card(){
		$.ajax({
			url:"<?php echo base_url() ?>dashboard/cron",
			dataType:"json",
			type:"POST",
			beforeSend:function(){
			...
			success:function(data){
				$("#quot_hari").html(data[0].quot_hari);
				$("#quot_bln").html(data[0].quot_bulan);
				$("#inq_hari").html(data[0].inq_hari);
				$("#inq_bln").html(data[0].inq_bulan);
				$("#po_in_hari").html(data[0].po_in_hari);
				$("#po_in_bln").html(data[0].po_in_bulan);
				$("#po_out_hari").html(data[0].po_out_hari);
				$("#po_out_bln").html(data[0].po_out_bulan);
				$("#inv_out_hari").html(data[0].inv_out_hari);
				$("#inv_out_bln").html(data[0].inv_out_bln);
	...
	function act(){
		$.ajax({
			url:"<?php echo base_url() ?>dashboard/aktivitas",
			dataType:"json",
			type:"POST",
			beforeSend:function(){
