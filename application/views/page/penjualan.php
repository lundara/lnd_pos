						 ...
						 <div class="col-md-12 col-sm-12">
						 	<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									...
									<tfoot>
										<tr>
											<th colspan="5"><center>SUBTOTAL</center></th>
...
<script>
	...
	$(document).ready(function() {
		...
		$("#ftpmb").submit(function(e){
			...
			if (nominal !=="" || nominal !==0) {
				$.ajax({
					type:"POST",
					url:"<?php echo base_url() ?>penjualan/add_pembayaran",
					dataType:"json",
	    ...
	    table = $('#datatable_ajax').DataTable({ 
	        ...
	        "ajax": {
	            "url": "<?php echo site_url('penjualan/data')?>",
	            "type": "POST",
	            "dataType":"json",
	            "data":function ( d ) {
	                  return $.extend( {}, d, {
	...
	function unduh(){
		...
		window.open('<?php echo base_url() ?>penjualan/excel?src_trans='+src_trans+'&src_from='+src_from+'&src_to='+src_to+'&src_pelanggan='+src_pelanggan+'&src_user='+src_user+'&src_status='+src_status+'&src_pembayaran='+src_pembayaran+'&src_plat='+src_plat+'&src_lunas='+src_lunas, '_blank');
	...
	function detail(id){
		...
		$.ajax({
			type:"POST",
			url:"<?php echo base_url() ?>penjualan/detail",
			dataType:"json",
			data:{id},
			beforeSend:function(){
	...
	function edit_draft(id){
		...
		$.ajax({
			type:"POST",
			url:"<?php echo base_url() ?>penjualan/edit_draft",
			dataType:"json",
			data:{id},
			beforeSend:function(){
	...
	function draft(){
		...
		if (pelanggan !== "") {
			$.ajax({
				...
				type:"POST",
				url:"<?php echo base_url() ?>penjualan/draft",
				dataType:"json",
				data:{no_trans, item, pelanggan},
				beforeSend:function(){
		...
		if (pelanggan && bayar !== "") {
			if (bayar >= gtotal) {
				$.ajax({
					...
					type:"POST",
					url:"<?php echo base_url() ?>penjualan/save_draft",
					dataType:"json",
					data:{no_trans, pelanggan, bayar, kembalian, gtotal, bayar},
					beforeSend:function(){
		...
		if (pelanggan && bayar !== "") {
			if (bayar >= gtotal) {
				$.ajax({
					...
					type:"POST",
					url:"<?php echo base_url() ?>penjualan/save",
					dataType:"json",
					data:{no_trans, item, pelanggan, bayar, kembalian, gtotal, bayar},
					beforeSend:function(){
	...
	function dt(){
		$.ajax({
			...
			type:"POST",
			url:"<?php echo base_url();?>penjualan/data_item",
			dataType:"json",
			beforeSend:function(){
	...
	function del(id, i){
		...
		$.ajax({
			...
			type:"POST",
			url:"<?php echo base_url();?>penjualan/del",
			dataType:"json",
			data:{id},
			beforeSend:function(){
	...
	function edel(id, i){
		...
		$.ajax({
			...
			type:"POST",
			url:"<?php echo base_url();?>penjualan/del_draft",
			dataType:"json",
			data:{id},
			beforeSend:function(){
	...
	function add_draft(){
		...
		if (id && qty !=="") {
			$.ajax({
				...
				type:"POST",
				url:"<?php echo base_url();?>penjualan/add_draft",
				dataType:"json",
	...
	function get_trans(){
		$.ajax({
			type:"POST",
			url:"<?php echo base_url() ?>penjualan/get_trans",
			dataType:"json",
			success:function(data){
