					...
					<div class="col-md-12">
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-database"></i> Data Satuan
								</div>
								<div class="tools">
								...
								<div class="">
									...
									<table class="table table-striped table-bordered table-hover" id="datatable_ajax">
										...
										<thead>
											<tr>
												<th></th>
												<th><input class="form-control" id="src_nama" placeholder="Cari Nama Satuan..."></th>
												<th></th>
											</tr>
										</thead>
									<tbody>
...
<script>
	...
	$(document).ready(function() {
		...
		$("#add-form").on("submit",(function(e){
			...
			if (nama!=="") {
				$.ajax({
					url:"<?php echo base_url()?>satuan/tambah",
					type:"POST",
					data: {nama},
					daraType:"json",
					cache:false,
	    ...
	    table = $('#datatable_ajax').DataTable({ 
	        ...
	        "ajax": {
	            "url": "<?php echo site_url('satuan/data')?>",
	            "type": "POST",
	            "data":function ( d ) {
	                  return $.extend( {}, d, {
	...
	function del(){
		var id = $("#get_id").val();
		$.ajax({
			url:"<?php echo base_url()?>satuan/hapus",
			type:"POST",
			data: {id},
			daraType:"json",
			cache:false,
