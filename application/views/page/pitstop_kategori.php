<div class="page-content">
				...
				<!-- BEGIN PAGE HEADER-->
				<h3 class="page-title">
					Kategori Produk Pit Stop <small></small>
				</h3>
				<div class="page-bar">
					<ul class="page-breadcrumb">
						<li>
							<i class="fa fa-cube"></i>
							<a href="javascript:;">Kategori Produk Pit Stop</a>
						</li>
					</ul>
								...
								<div class="">
									...
									<table class="table table-striped table-bordered table-hover" id="datatable_ajax">
										...
										<thead>
											<tr>
												<th></th>
												<th><input class="form-control" id="src_nama" placeholder="Cari Nama Kategori..."></th>
												<th></th>
											</tr>
										</thead>
									<tbody>
...
<script>
	...
	$(document).ready(function() {
		...
		$("#add-form").on("submit",(function(e){
			...
			if (nama!=="") {
				$.ajax({
					url:"<?php echo base_url()?>pitstop/kategori/tambah",
					type:"POST",
					data: {nama},
					daraType:"json",
					cache:false,
		...
		$("#edit-form").on("submit",(function(e){
			...
			if (nama!=="") {
				$.ajax({
					url:"<?php echo base_url()?>pitstop/kategori/update",
					type:"POST",
					data: {nama, id},
					daraType:"json",
					cache:false,
	    ...
	    table = $('#datatable_ajax').DataTable({ 
	        ...
	        "ajax": {
	            "url": "<?php echo site_url('pitstop/kategori/data')?>",
	            "type": "POST",
	            "data":function ( d ) {
	                  return $.extend( {}, d, {
	...
	function edit(id){
		getId(id);
		$.ajax({
			url:"<?php echo base_url()?>pitstop/kategori/edit",
			type:"POST",
			data: {id},
			daraType:"json",
			cache:false,
			...
			success:function(data){
				$("#enama").val(data[0].nama_kategori);
			},
			complete:function(){
	...
	function del(){
		var id = $("#get_id").val();
		$.ajax({
			url:"<?php echo base_url()?>pitstop/kategori/hapus",
			type:"POST",
			data: {id},
			daraType:"json",
			cache:false,
