...
class pelanggan extends CI_Controller {
    ...
    function __construct(){
        ...
        $this->load->model('Pelanggan_model','md');
    ...
    public function hapus(){
        ...
        $this->db->where("id", $id);
        $satuan = $this->db->get("pelanggan")->row_array();
        ...
        $dt_act = array(
            "deskripsi"         => $user["nama"]." telah menghapus data User ".$satuan['nama_pelanggan'].".",
    ...
    public function tambah(){
        ...
        $dt_act = array(
                "deskripsi"         => $user["nama"]." telah menambah data Pelanggan ".$nama.".",
    ...
    public function update(){
        ...
        $dt_act = array(
                "deskripsi"         => $user["nama"]." telah mengubah data User ".$nama.".",
