...
class stok_pitstop extends CI_Controller {

    function __construct(){
        parent::__construct();
        date_default_timezone_set("Asia/Jakarta");
        $this->load->model('Stok_pitstop_model','md');
    ...
    function im_st(){
        $d = $this->db->get("pitstop_produk")->result();
        ...
        foreach ($d as $v) {
            ...
            $this->db->insert("pitstop_stok", $dt);
        }
    }
    ...
    public function detail(){
        ...
        $data["g"]   	  = $c;     
        $data["page"]     = "stok_pitstop";
        $data["menu"]     = "inventory";
        $data["submenu"]  = "stok_pitstop";
        $this->load->view('main', $data);
    }
