...
class supplier extends CI_Controller {
    ...
    function __construct(){
        ...
        $this->load->model('pitstop/Supplier_model','md');
    ...
    public function select(){
        ...
        $sl = "
            pitstop_supplier.id,
            pitstop_supplier.nama_cabang AS name
        ";
        $this->db->select($sl);
        $this->db->from("pitstop_supplier");
        $data = $this->db->get()->result();
    ...
    public function edit(){
        ...
        $this->db->where("id", $id);
        $data = $this->db->get("pitstop_supplier")->result();
        header('Content-Type: application/json');
        echo json_encode($data);
    }
    ...
    public function hapus(){
        ...
        $this->db->where("id", $id);
        $satuan = $this->db->get("pitstop_supplier")->row_array();
        ...
        $this->db->trans_start();
            $this->db->where("id", $id);
            $this->db->delete("pitstop_supplier");
    ...
    public function tambah(){
        ...
        $this->db->trans_start();
            $this->db->insert("pitstop_supplier", $dt);
    ...
    public function update(){
        ...
        $this->db->trans_start();
            $this->db->where("id", $id);
            $this->db->update("pitstop_supplier", $dt);
