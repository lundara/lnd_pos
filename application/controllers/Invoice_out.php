...
class invoice_out extends CI_Controller {
    ...
    public function index(){        
        ...
        $this->lnd->akses("invoice_out", "submenu");

        $data["page"]     = "invoice_out";
        $data["menu"]     = "transaksi";
        $data["submenu"]  = "invoice_out";
    ...
    function save(){
        ...
        $ket_term   = ucwords($_POST["ket_term"]);
        $ket_tax    = ucwords($_POST["ket_tax"]);
        ...
        $dt_act = array(
            "deskripsi"         => $user["nama"]." telah menambah data Invoice Out ".$no_trans.".",
